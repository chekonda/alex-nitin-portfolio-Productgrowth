  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 -z-10" aria-hidden="true">
        ...
        <div className="absolute -top-40 right-[-10%] h-[32rem] w-[32rem] rounded-full bg-accent-600/20 blur-[120px]" />
        <div className="absolute bottom-[-10rem] left-[-10%] h-[24rem] w-[24rem] rounded-full bg-sky-400/10 blur-[120px]" />
        <div className="bg-grain absolute inset-0 opacity-60" />
      </div>

      <Container className="grid items-center gap-14 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10">
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-accent-300 to-sky-400 bg-clip-text text-transparent">
          ...
          <motion.div variants={item} className="mt-9 flex flex-wrap items-center gap-3">
            ...
            <Button href="#about" variant="secondary" onClick={scrollTo('#about')}>
              More about me
            </Button>
          </motion.div>
